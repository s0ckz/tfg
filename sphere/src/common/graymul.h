...
enum ITEMID_TYPE	// InsideUO is great for this stuff.
{
	...
	ITEMID_DOOR_SECRET_1		= 0xE8,

	ITEMID_DOOR_SECRET_2		= 0x314,
	ITEMID_DOOR_SECRET_3		= 0x324,
	ITEMID_DOOR_SECRET_4		= 0x334,
	ITEMID_DOOR_SECRET_5		= 0x344,
	ITEMID_DOOR_SECRET_6		= 0x354,

	ITEMID_DOOR_METAL_S			= 0x675,	// 1
	ITEMID_DOOR_BARRED			= 0x685,	// 2
	ITEMID_DOOR_RATTAN			= 0x695,	// 3
	ITEMID_DOOR_WOODEN_1		= 0x6A5,	// 4
	ITEMID_DOOR_WOODEN_2		= 0x6B5,	// 5
	ITEMID_DOOR_METAL_L			= 0x6C5,	// 6
	ITEMID_DOOR_WOODEN_3		= 0x6D5,	// 7
	ITEMID_DOOR_WOODEN_4		= 0x6E5,	// 8

	ITEMID_DOOR_IRONGATE_1		= 0x824,
	ITEMID_DOOR_WOODENGATE_1	= 0x839,
	ITEMID_DOOR_IRONGATE_2		= 0x84C,
	...
	ITEMID_HOUSE_SMALL_ST		= ITEMID_MULTI + 0x66,
	ITEMID_HOUSE_SMALL_BR		= ITEMID_MULTI + 0x68,
	ITEMID_HOUSE_SMALL_WD		= ITEMID_MULTI + 0x6A,
	ITEMID_HOUSE_SMALL_WD_PL	= ITEMID_MULTI + 0x6C,
	ITEMID_HOUSE_SMALL_TH		= ITEMID_MULTI + 0x6E,
	ITEMID_HOUSE_3ROOM			= ITEMID_MULTI + 0x74,
	ITEMID_HOUSE_2STORY_WD_PL	= ITEMID_MULTI + 0x76,
	ITEMID_HOUSE_2STORY_ST_PL	= ITEMID_MULTI + 0x78,
	ITEMID_TOWER				= ITEMID_MULTI + 0x7A,
	ITEMID_KEEP					= ITEMID_MULTI + 0x7C,
	ITEMID_CASTLE				= ITEMID_MULTI + 0x7E,
	ITEMID_HOUSE_BLACKSMITH		= ITEMID_MULTI + 0x8C,
	ITEMID_HOUSE_MARBLE_PATIO	= ITEMID_MULTI + 0x96,
	ITEMID_HOUSE_SMALL_TOWER	= ITEMID_MULTI + 0x98,
	ITEMID_HOUSE_LOG_CABIN		= ITEMID_MULTI + 0x9A,
	ITEMID_HOUSE_SANDSTONE		= ITEMID_MULTI + 0x9C,
	ITEMID_HOUSE_2STORY_VILLA	= ITEMID_MULTI + 0x9E,
	ITEMID_HOUSE_SMALL_SHOP_ST	= ITEMID_MULTI + 0xA0,
